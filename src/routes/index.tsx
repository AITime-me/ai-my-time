    ...
    <SiteLayout>
      ...
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <Reveal>
          ...
          <H2 className="mt-4 max-w-3xl">AI не заменяет хорошего человека. Он убирает слой рутины до человека.</H2>
          <Lead>
        ...
        <div className="mt-10 grid gap-4 lg:grid-cols-2">
          ...
          <GlassCard className="border-[color:var(--lime)]/40">
            ...
            <p className="mt-3 text-base text-foreground/90">
              «Подскажу. Чтобы подобрать решение, мне нужно уточнить пару вещей: какая у вас задача, где сейчас проседает процесс и что вы хотите снять с ручного контроля?»
            </p>
          </GlassCard>
        </div>
      </section>
