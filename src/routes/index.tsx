...
const examples = [
  { title: "Сайт с AI и SEO-структурой", text: "Сайт не как витрина, а как рабочая точка с заявками, SEO-структурой (семантическое ядро), аналитикой и подготовкой к интеграции AI и бота." },
  { title: "AI-администратор / AI-менеджер", text: "Автоматизация общения, консультаций и обработки заявок." },
  { title: "Приложения для бизнеса", text: "Мини-инструменты, дашборды и системы для учёта заявок и процессов." },
  { title: "AI-разбор бизнеса", text: "Диагностика процессов, выявление проблем и точек потерь." },
  { title: "Квизы и формы", text: "Интерактивные сценарии для сбора заявок и клиентов." },
